...
with open("/home/mariapap/DATASETS/NatFuel_NatGrid_buildings_dataset/lists/train_list.txt", "r") as file:
    train_ids = [line.strip() for line in file.readlines()]

with open("/home/mariapap/DATASETS/NatFuel_NatGrid_buildings_dataset/lists/val_list.txt", "r") as file:

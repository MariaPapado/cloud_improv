...
model_weights = torch.load('./saved_models/net_11.pt')
#model_weights = torch.load('./saved_models/net_10.pt')
...
with open("/home/mariapap/DATASETS/NatFuel_NatGrid_buildings_dataset/lists/test_list.txt", "r") as file:
    ids = [line.strip() for line in file.readlines()]

data_path = '/home/mariapap/DATASETS/NatFuel_NatGrid_buildings_dataset/PATCHES/'
...
for id in ids:
    img = Image.open('/home/mariapap/DATASETS/NatFuel_NatGrid_buildings_dataset/PATCHES/images/{}'.format(id))

    label = Image.open('/home/mariapap/DATASETS/NatFuel_NatGrid_buildings_dataset/PATCHES/labels/{}'.format(id))
